...
const routes: Routes = [
  ...
  {
    path: 'cadastro',
    loadChildren: () => import('./cadastrar/cadastro/cadastro.module').then( m => m.CadastroPageModule)
  },
  {
    path: 'inicio',
  ...
  },
  {
    ...
    loadChildren: () => import('./disponibilidade/disponibilidade.module').then( m => m.DisponibilidadePageModule)
  },
  {
    path: 'editar-usuario',
